...
SET filenames=SequentialSignalAssignment.vhd tbSequentialSignalAssignments.vhd

::Add names of the testbenches here
SET TBNames=tbSequentialSignalAssignments
SET TBDNames=tbdSequentialSignalAssignments
