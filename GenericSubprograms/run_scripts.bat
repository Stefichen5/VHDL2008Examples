...
SET filenames=packGenericSubprogram.vhd packStateMachine.vhd ea-StateMachine.vhd tbStateMachine.vhd

::Add names of the testbenches here
SET TBNames=tbStateMachine
SET TBDNames=tbdStateMachine
