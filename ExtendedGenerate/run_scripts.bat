...
SET filenames=packGenerateType.vhd EntitiesToGenerate.vhd ElseGenerate.vhd CaseGenerate.vhd tbExtendedGenerate.vhd

::Add names of the testbenches here
SET TBNames=tbExtendedGenerate
SET TBDNames=tbdExtendedGenerate
